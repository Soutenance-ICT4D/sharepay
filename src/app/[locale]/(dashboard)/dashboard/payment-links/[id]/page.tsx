...
import { ProductDetailsSection } from "@/components/dashboard/payment-links/new/product-details-section";
import { PricingSection } from "@/components/dashboard/payment-links/new/pricing-section";
import { BrandingSection } from "@/components/dashboard/payment-links/new/branding-section";
import { AdvancedOptionsSection } from "@/components/dashboard/payment-links/new/advanced-options-section";
import { PaymentPreview } from "@/components/dashboard/payment-links/new/payment-preview";

export default function EditPaymentLinkPage(props: { params: Promise<{ id: string }> }) {
    const params = use(props.params);
    const t = useTranslations('Dashboard.PaymentLinks.Edit');
    ...
    return (
        <div className="space-y-8 p-6 md:p-8 pt-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            {/* Header */}

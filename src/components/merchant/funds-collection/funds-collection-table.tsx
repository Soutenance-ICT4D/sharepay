...
// Mock Data Type
export type FundsCollectionLink = {
    id: string;
    name: string;
    amount: number | "Libre";
    currency: string;
...
interface FundsCollectionTableProps {
    data: FundsCollectionLink[];
}

export function FundsCollectionTable({ data }: FundsCollectionTableProps) {
    ...
    const columns: ColumnDef<FundsCollectionLink>[] = [
        {
            accessorKey: "name",
            header: t("name"),
            cell: ({ row }) => (
                ...
                return (
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                            ...
                            <DropdownMenuSeparator />
                            <DropdownMenuItem onClick={() => router.push(`/merchant/funds-collection/${item.id}`)}>

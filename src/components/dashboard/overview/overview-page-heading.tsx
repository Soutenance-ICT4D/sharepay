...
export function OverviewPageHeading({
    ...
    return (
        <div ref={rootRef} className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center w-full lg:w-auto">
                <div className="relative w-full sm:w-auto">
                    ...
                    {dateMenuOpen ? (
                        <div
                            className="absolute left-0 sm:left-auto sm:right-0 mt-2 w-full sm:w-[240px] rounded-md border bg-card text-card-foreground shadow-lg z-50 overflow-hidden"
                            role="menu"
                        >
                            <button
                                type="button"
